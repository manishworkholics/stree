                            ...
                            <div className="modal-body">
                                ...
                                <div className="row">
                                    <div className="col-md-6 mb-2">
                                        ...
                                        <select className="form-select" value={newItem.category} onChange={(e) => handleItemChange("category", e.target.value)}>
                                    ...
                                    <div className="col-md-6 mb-2">
                                        <label>Product</label>
                                        <select className="form-select" value={newItem.name} onChange={(e) => handleItemChange("name", e.target.value)}>
                                            <option value="">Select</option>
                                            {newItem.category === "Dress" && dressList.map((d) => <option key={d.id} value={d.name}>{d.name}</option>)}
                                            {newItem.category === "Jewellery" && jewelleryList.map((j) => <option key={j.id} value={j.name}>{j.name}</option>)}
                                        </select>
                                    </div>
                                    <div className="col-md-6 mb-2">
                                        <label>Code</label>
                                        <input type="text" className="form-control" value={newItem.code} onChange={(e) => handleItemChange("code", e.target.value)} />
                                    </div>
                                    <div className="col-md-6 mb-2">
                                        <label>Size</label>
                                        <input type="text" className="form-control" value={newItem.size} onChange={(e) => handleItemChange("size", e.target.value)} />
                                    </div>
                                    <div className="col-md-4 mb-2">
                                        <label>Quantity</label>
                                        <input type="number" min="1" className="form-control" value={newItem.quantity} onChange={(e) => handleItemChange("quantity", parseInt(e.target.value) || 1)} />
                                    </div>
                                    <div className="col-md-4 mb-2">
                                        <label>Rate</label>
                                        <input type="number" className="form-control" value={newItem.rate} onChange={(e) => handleItemChange("rate", parseFloat(e.target.value) || 0)} />
                                    </div>
                                    <div className="col-md-4 mb-2">
                                        <label>Amount</label>
                                        <input type="number" className="form-control" value={newItem.amount.toFixed(2)} readOnly />
                                    </div>
                                    <div className="col-md-6 mb-2">
