                        ...
                        <div className="breadcrumb__menu">
                          <nav>
                            <ul>
                              ...
                              <li className="active"><span>Category Item</span></li>
                            </ul>
                          </nav>
                        </div>
                      </div>
                ...
                <div className="body__card-wrapper">
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><span>Rental</span></td>
                          <td><span>Plastic chair</span></td>
                          <td><span>pcs</span></td>
                          <td><span>₹50</span></td>
                          <td>
                        ...
                        <tr>
                          <td><span>2</span></td>
                          <td><span>Stage Lights</span></td>
                          <td><span>Lighting</span></td>
                          <td><span>Rental</span></td>
                          <td><span>LED stage lights</span></td>
                          <td><span>set</span></td>
                          <td><span>₹500</span></td>
                          <td>
                            <button onClick={openModal} className="btn border-0">
                  ...
                  <div className="basic__pagination d-flex align-items-center justify-content-end">
                    <div className="pagination">
                      <nav>
                        <ul className="">
                          <li><button disabled><i className="fa-solid fa-arrow-left"></i></button></li>
                          <li><button className="active me-1">1</button></li>
                          <li><button className="me-1">2</button></li>
                          <li><button><i className="fa-solid fa-arrow-right"></i></button></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <form>
                        <div className="mb-15">
                          <label className="input__field-text">Category Item</label>
                          <input type="text" placeholder="Enter Category Item" />
                        </div>
                        <div className="mb-15">
                        ...
                        <div className="mb-15">
                          <label className="input__field-text">Item Type</label>
                        ...
                        <div className="mb-15">
                          <label className="input__field-text">Measurement Unit</label>
                          <input type="text" placeholder="Enter Measurement Unit" />
                        </div>
                        <div className="mb-15">
